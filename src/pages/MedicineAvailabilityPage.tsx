    ...
    <div className="space-y-6 text-left animate-fade-in-up">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-3xl border border-slate-200/80 shadow-xs hover-lift">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">
                  Inter-Facility Medicine Inventory & Stock
                </h1>
        ...
        <button
          ...
          className="px-4 py-2 rounded-full text-xs sm:text-sm font-bold bg-emerald-800 hover:bg-emerald-900 text-white flex items-center gap-2 shadow-xs transition-all self-start sm:self-auto cursor-pointer btn-lift"
        >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-4 rounded-3xl border border-slate-200/80 shadow-xs hover-lift">
        ...
        <div className="flex items-center gap-2 text-xs font-semibold flex-wrap">
          ...
          <select
            ...
            className="px-3 py-1.5 rounded-full border border-slate-200 bg-white text-xs font-medium"
          >
                  ...
                  <td className="py-3.5 px-3 text-right">
                    <div className="inline-flex items-center gap-1.5">
                      ...
                      <button
                        ...
                        className="px-2.5 py-1 rounded-full text-[11px] font-bold bg-slate-100 hover:bg-slate-200 text-slate-700 ml-1 flex items-center gap-1 transition-colors"
                      >
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2.5 rounded-2xl border font-mono font-bold text-sm"
                    required
                  />
                </div>
